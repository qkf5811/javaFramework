...
var xhr2 = createXMLHttpRequest();
	...
	document.cookie =" 3112003000_XZKC" + "=XZKC=0100350_0_%E5%BD%93%E4%BB%A3%E5%9B%BD%E7%B1%8D%E8%B4%B8%E6%98%93%E5%AF%BC%E8%AE%BA_0.5_%E8%AE%A1%E5%88%92%E8%AF%BE%E7%A8%8B" + ';expires='+d.toGMTString()+';';
...
//	xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded"); http://202.192.240.54/tbx/txkc/confirm.aspx
	...
	xhr1.onreadystatechange = function() {
						...
						if (xhr1.readyState == 4 && xhr1.status == 320) {
							console.log("success!");
					//		kcArrs += 1;
							//刷新
...
//	xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded"); http://202.192.240.54/tbx/txkc/confirm.aspx
	...
	xhr2.onreadystatechange = function() {
						...
						if (xhr2.readyState == 4 && xhr2.status == 320) {
							console.log("success!");
					//		kcArrs += 1;
							//刷新
						//	document.getElementsByClassName("tbui_fbar_refresh")[0].click();
